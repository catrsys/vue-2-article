...
```
В случаях, когда внедрение доверенного либо санитизированного HTML, CSS и JavaScript необходимо, предлагаются следующие решения:
* внедрение HTML: `v-html`, упомянутый в предыдущем подразделе
```html
