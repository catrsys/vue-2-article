...
Эта команда не просто обновляет зависимости проекта: она заменяет версии,в которых была обнаружена уязвимость, на версии, в которых эта уязвимость либо закрыта, либо еще не появилась.
